...
@router.delete("/computers/all_unsafe")
@inject
async def delete_all_computers(
    service: Annotated[ComputerService, Inject],
) -> dict:
    # Quick utility for resetting demo data
    # Requires service implementation
    await service.delete_all_computers()
    return {"message": "All computers deleted"}
